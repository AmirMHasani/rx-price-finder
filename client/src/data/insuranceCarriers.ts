...
export interface InsurancePlan {
  id: string; // Plan ID - can be InsurancePlanType or custom string
  name: string;
  description?: string;
  region?: string; // For grouping regional variations (e.g., "California", "Texas", "National")
  regionalCarrier?: string; // Display name for regional carrier (e.g., "Blue Shield of California")
}
...
export const INSURANCE_CARRIERS: InsuranceCarrier[] = [
  ...
  },
  {
    ...
    plans: [
      ...
      { id: 'bcbs_pos', name: 'POS Plan', description: 'Point of Service', region: 'National' },
      { id: 'bcbs_hsa', name: 'HSA Plan', description: 'High deductible with savings', region: 'National' },

      // Multi-State - Anthem BCBS
      { id: 'anthem_ppo', name: 'PPO Plan', description: 'Preferred Provider Organization', region: 'Multi-State', regionalCarrier: 'Anthem BCBS' },
      { id: 'anthem_hmo', name: 'HMO Plan', description: 'Health Maintenance Organization', region: 'Multi-State', regionalCarrier: 'Anthem BCBS' },
      { id: 'anthem_epo', name: 'EPO Plan', description: 'Exclusive Provider Organization', region: 'Multi-State', regionalCarrier: 'Anthem BCBS' },
      { id: 'anthem_hdhp', name: 'High Deductible Health Plan', description: 'HSA-eligible', region: 'Multi-State', regionalCarrier: 'Anthem BCBS' },
      ...
      { id: 'blue_shield_ca_trio', name: 'Trio HMO', description: 'Narrow network', region: 'California', regionalCarrier: 'Blue Shield of California' },
      ...
      // Texas - BCBS of Texas
      { id: 'bcbs_texas_blue_advantage', name: 'Blue Advantage (HMO)', description: 'Texas network', region: 'Texas', regionalCarrier: 'BCBS of Texas' },
      { id: 'bcbs_texas_blue_choice', name: 'Blue Choice (PPO)', description: 'Statewide coverage', region: 'Texas', regionalCarrier: 'BCBS of Texas' },

      // Illinois - BCBS of Illinois
      { id: 'bcbs_il_blue_precision', name: 'Blue Precision (HMO)', description: 'Illinois network', region: 'Illinois', regionalCarrier: 'BCBS of Illinois' },
      { id: 'bcbs_il_blue_choice', name: 'Blue Choice (PPO)', description: 'Flexible network', region: 'Illinois', regionalCarrier: 'BCBS of Illinois' },

      // Michigan - BCBS of Michigan
      { id: 'bcbs_mi_community_blue', name: 'Community Blue (PPO)', description: 'Michigan coverage', region: 'Michigan', regionalCarrier: 'BCBS of Michigan' },
      { id: 'bcbs_mi_simply_blue', name: 'Simply Blue (HMO)', description: 'Lower cost option', region: 'Michigan', regionalCarrier: 'BCBS of Michigan' },

      // North Carolina - BCBS of North Carolina
      { id: 'bcbs_nc_blue_options', name: 'Blue Options (HMO)', description: 'NC network', region: 'North Carolina', regionalCarrier: 'BCBS of North Carolina' },
      { id: 'bcbs_nc_blue_value', name: 'Blue Value (PPO)', description: 'Flexible coverage', region: 'North Carolina', regionalCarrier: 'BCBS of North Carolina' },

      // Pennsylvania - Independence Blue Cross
      { id: 'ibc_personal_choice', name: 'Personal Choice (PPO)', description: 'PA/NJ/DE network', region: 'Pennsylvania', regionalCarrier: 'Independence Blue Cross' },
      { id: 'ibc_keystone', name: 'Keystone HMO', description: 'Coordinated care', region: 'Pennsylvania', regionalCarrier: 'Independence Blue Cross' },

      // Multi-State - Highmark BCBS
      { id: 'highmark_community_blue', name: 'Community Blue (PPO)', description: 'Multi-state network', region: 'Multi-State', regionalCarrier: 'Highmark BCBS' },
      { id: 'highmark_blue_hmo', name: 'Blue HMO', description: 'Network-based care', region: 'Multi-State', regionalCarrier: 'Highmark BCBS' },

      // MD/DC/VA - CareFirst BCBS
      { id: 'carefirst_bluepreferred', name: 'BluePreferred (PPO)', description: 'MD/DC/VA network', region: 'MD/DC/VA', regionalCarrier: 'CareFirst BCBS' },
      { id: 'carefirst_bluechoice', name: 'BlueChoice (HMO)', description: 'Lower cost option', region: 'MD/DC/VA', regionalCarrier: 'CareFirst BCBS' },

      // WA/AK - Premera Blue Cross
      { id: 'premera_heritage_plus', name: 'Heritage Plus (PPO)', description: 'WA/AK network', region: 'WA/AK', regionalCarrier: 'Premera Blue Cross' },
      { id: 'premera_lifewise', name: 'LifeWise (HMO)', description: 'Coordinated care', region: 'WA/AK', regionalCarrier: 'Premera Blue Cross' },
    ],
  },
  {
    id: 'centene',
...
export function getCarrierPlans(carrierId: string): string[] {
...
export function getCarrierByPlanId(planId: string): InsuranceCarrier | undefined {
